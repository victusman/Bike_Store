...
$stmtDestacados = $pdo->query("SELECT * FROM v_productos_destacados");
$productosDestacados = $stmtDestacados->fetchAll();

// Obtener productos más vendidos (máximo 4)
$stmtVendidos = $pdo->query("SELECT * FROM v_productos_mas_vendidos");
        ...
        <div class="col">
            <div class="card h-100 shadow-sm hover-shadow">
                ...
                <div class="position-absolute top-0 end-0 m-2">
                    <span class="discount-badge">-<?php echo number_format($producto['descuento'], 0); ?>%</span>
                </div>
                <?php endif; ?>
